...
app.post("/postUsuarios", async function (req, res) {
  ...
  const usuarioCreado = await realizarQuery(
    `INSERT INTO Usuarios(email, nombre, apellido, nombre_de_usuario, contraseña) VALUES ('${req.body.email}', '${req.body.nombre}', '${req.body.apellido}', '${req.body.nombre_de_usuario}', '${req.body.contraseña}')`
  );

  console.log({ usuarioCreado })
  res.send(usuarioCreado[0]);
});
